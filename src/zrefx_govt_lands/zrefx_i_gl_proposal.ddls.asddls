...
@EndUserText.label: 'Proposal for GL'
@Metadata.ignorePropagatedAnnotations: true
define  view entity ZREFX_I_GL_PROPOSAL as select from zrefx_gl_psl
  ...
  association        to ZREFX_I_GL_STATUS             as _Status      on  _Status.Statustype             = 'PROPOSAL'
                                                                 and $projection.Proposalstatuscode = _Status.Code

  association [1..1] to ZREFX_I_GL_WORKFLOW_INSTANCE  as _Workflow    on  _Workflow.Objecttype  = 'PROPOSAL'

  association to ZREFX_I_GL_PROPOSEDLAND as _Land on $projection.RequestId = _Land.RequestId

  composition of many ZREFX_I_GL_PROPOSEDLAND         as _ProposedLand
{

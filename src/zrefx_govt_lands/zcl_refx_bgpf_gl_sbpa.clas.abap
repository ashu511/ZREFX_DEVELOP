CLASS zcl_refx_bgpf_gl_sbpa DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    METHODS set_context_data
      IMPORTING requestid   TYPE string
...
CLASS zcl_refx_bgpf_gl_sbpa IMPLEMENTATION.
  ...
  METHOD if_bgmc_op_single~execute.
    ...
    DATA(ls_payload) = VALUE ty_sbpa_payload(
      definition_id = 'sa30.sec-rs-dev-6durkmdm.re01cgovernmentownedland.rightOfWayProcess'
      context       = gs_context
    ).
    ...
    TRY.
        ...
        IF lv_status-code = 200 OR lv_status-code = 201 OR lv_status-code = 202.
          ...
          IF ls_response-id IS NOT INITIAL.
            ...
            " Use RAP EML to insert the log into zrefx_gl_workin.
            " adjust_numbers will automatically generate the 'LogUuid' UUID!

...
define view entity ZREFX_I_GL_PROPOSEDLAND
  as select from zrefx_row_propl
  association [0..*] to ZREFX_I_GL_REQUEST         as _LandRequest  on  $projection.RequestId = _LandRequest.RequestId

  association        to parent ZREFX_I_GL_PROPOSAL as _Proposal    on  $projection.ProposalId = _Proposal.Id
                                                                   and $projection.RequestId  = _Proposal.RequestId

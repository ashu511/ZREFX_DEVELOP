...
define view entity ZREFX_I_GL_SITEVISITNOM
  ...
  association        to ZREFX_I_GL_STATUS            as _Status      on  _Status.Statustype     = 'NOMINATION'
                                                                      and $projection.Statuscode = _Status.Code

  association [1..1] to ZREFX_I_GL_WORKFLOW_INSTANCE as _Workflow    on  _Workflow.Objecttype = 'NOMINATION'
{

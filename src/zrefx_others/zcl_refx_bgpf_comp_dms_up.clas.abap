CLASS zcl_refx_bgpf_comp_dms_up DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
* Group by Complaint ID to avoid redundant folder checks/creation
    ...
    DATA(lv_folder_path) = |/{ ls_first_item-complaintid }|.
...
* Create folder if missing
        ...
        APPEND VALUE #( id = cl_cmis_property_ids=>name
                        values = VALUE #( ( string_value = ls_first_item-complaintid ) ) ) TO lt_properties.

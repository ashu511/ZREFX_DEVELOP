CLASS zcl_refx_row_config DEFINITION
  PUBLIC
  FINAL
  CREATE PRIVATE.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS get_instance RETURNING VALUE(ro_instance) TYPE REF TO zcl_refx_row_config.
  ...
  PRIVATE SECTION.
    CLASS-DATA go_instance TYPE REF TO zcl_refx_row_config.
ENDCLASS.

CLASS zcl_refx_row_config IMPLEMENTATION.
  ...
  METHOD get_sbpa_destination.
    SELECT SINGLE config_value FROM zrefx_row_config
